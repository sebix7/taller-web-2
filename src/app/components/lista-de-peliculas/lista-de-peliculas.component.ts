  ...
  peliculas: Pelicula[] = [
    {
      ...
      descripcion:"En esta película, Sonic se une al alguacil local de un pueblo, Tom Wachowski, para escapar de fuerzas gubernamentales secretas y derrotar a Robotnik, quien quiere robar los poderes de Sonic usando sus armas robot sumamente avanzadas para capturarlo.",
      genero:"Aventura",
      duracion:"120 MIN",
      actores:"Luisito",
